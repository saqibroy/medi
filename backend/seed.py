...
def seed() -> None:
    ...
    try:
        ...
        annotations = [
            Annotation(project_id=scans[0].project_id, scan_id=scans[0].id, label_id=label_by_project_and_name[(neuro_project.id, "tumour")].id, label="tumour", annotation_type="bounding_box", coordinates={"x": 120, "y": 140, "width": 86, "height": 72}, slice_index=32, created_by="Dr. Rao", confidence_score=0.93, review_status="approved", reviewer="Dr. Patel", reviewed_by_user_id=users[2].id, assigned_to_user_id=users[1].id),
            Annotation(project_id=scans[0].project_id, scan_id=scans[0].id, label_id=label_by_project_and_name[(neuro_project.id, "lesion")].id, label="lesion", annotation_type="polygon", coordinates={"points": [[180, 210], [230, 198], [260, 245], [205, 270]]}, slice_index=34, created_by="Dr. Rao", confidence_score=0.81, review_status="pending", assigned_to_user_id=users[1].id),
            Annotation(project_id=scans[0].project_id, scan_id=scans[0].id, label_id=label_by_project_and_name[(neuro_project.id, "normal")].id, label="normal", annotation_type="polygon", coordinates={"points": [[40, 60], [90, 72], [80, 130], [35, 118]]}, slice_index=10, created_by="Dr. Rao", confidence_score=0.88, review_status="approved", reviewer="Dr. Patel", reviewed_by_user_id=users[2].id, notes="Clear normal reference tissue for negative-class examples.", assigned_to_user_id=users[1].id),
            Annotation(project_id=scans[1].project_id, scan_id=scans[1].id, label_id=label_by_project_and_name[(thoracic_project.id, "lesion")].id, label="lesion", annotation_type="bounding_box", coordinates={"x": 260, "y": 210, "width": 64, "height": 90}, slice_index=55, created_by="Dr. Rao", confidence_score=0.77, review_status="pending", assigned_to_user_id=users[1].id),
